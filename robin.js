...
function startIntro() {
  dialogueLines = [
    ...
    {text:"See? It's alright. No harm done.", Robin: "pigtail_3.png", background: "hallway_sprite.png"},
    ...
    {text:"Hey, it's okay. Accidents happen. The concert is in a few days, right? Is that plenty of time for you?", Robin: "pigtail_5.png", background: "hallway_sprite.png"},
    {text:"Y-yes! Absolutely! I can.. fix it, you say quickly, clutching the torn fabric tightly against your chest as if you could hide your shame.", Robin: "pigtail_1.png", background: "hallway_sprite.png"},
    ...
    {text:"You freeze. You... you sew?", Robin: "pigtail_6.png", background:"hallway_sprite.png" },
    {text:"Sometimes! Come on, before I change my mind.", Robin: "pigtail_4.png", background: "hallway_sprite.png"},
...
function startPhoneCallScene() {
 dialogueLines = [
    ...
    {text:"It's really cool how you do your makeup yourself. I thought all idols had makeup artists.", Robin:"41.png"},
    ...
    {text:".", Robin:"43.png" },
    {text:"..", Robin:"44.png" },
    {text:"...If I'm going to be honest, you say, you're so creative.", Robin:"45.png" },
    {text:"A few hours before your performance starts, and you're doing everything by yourself.", Robin:"46.png"},
    {text:"...", Robin:"47.png"},
    {text:"Thank you, you're always so sweet.", Robin:"31.png"}
  ];
  currentLine = 0;
  dialogueText.innerHTML = dialogueLines[currentLine].text;
...
function startConcert() {
  dialogueLines = [
    ...
    {text: "You were on stage, heart pounding. She smiled at the audience.", Robin: "concert4.png"},
    {text: "This is my costume dessigner. Everyone, give her a big round of applause!", Robin:"concert3.png"},
    // after concert

    {text:"Afterwards, you and Robin went backstage.", background: "black.png"},
    {text:"It's so quiet out here compared to the stage, you whisper.", background: "concert_5.png"},
    {text:"She tilts her head, 'Yeah... it's nice to just breathe sometimes.'", Robin: "concert_3.png"},
    {text:"You looked radiant out there... and I've never had so much fun before on stage.", Robin: "concert_2.png"},
    {text:"Agreed.", Robin: "concert_3.png"},
    {text:"I like nights like this.", background: "concert_8.png"},
    {text:"No stage lights, no cameras in my face", Robin: "concert_8.png"},
    {text:"I can be me", Robin: "concert_15.png"},
    {text:"I was expecting you to be more... lively, you say, breaking the silence. Not like you aren't lively of course, but... I'm sorry. I shouldn't have said that.", Robin: "concert_9.png"},
    {text:"A moment passes before she responds into a geniune, laugh. Not the kind of one you hear on stage and just now. The kind that seemed so real.", Robin: "concert_13.png"},
    {text:"Haha! No, no, it's okay. I get that a lot. People always think I'm super energetic all the time because of my job.", Robin: "concert_12.png"},
    {text:"When I'm off stage, I'm like this. Quiet, reserved...", Robin: "concert_3.png"},
    {text:"But, you know, I also was thinking the same about you.", Robin: "concert_14.png"},
    {text:"You tilt your head, confused.", Robin: "concert_14.png"},
    {text:"You're always so confident in your pieces despite not being the one walking on the runway, she says, eyes sparkling. And everytime you make a public appearance...", Robin: "concert_6.png"},
    {text:"You have such a profound energy about you. It's really inspriring to see.", Robin: "concert_3.png"},
    {text:"But here, you're really shy and clumsy. It's very endearing.", Robin: "concert_10.png"},
    ...
    {text:"It's difficult when you never make public appearances, and then just show up. I get really nervous, and always want to put on an act.", Robin: "33.png"},
    {text:"Then maybe..", Robin: "34.png"},
    {text:"we're not so different after all.", Robin: "35.png"},
    {text:"...", Robin: "stars.png"},
